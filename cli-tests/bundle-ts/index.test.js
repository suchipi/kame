...
test("works", async () => {
  ...
  const run = firstBase.spawn(
    cli,
    ["bundle", "--input", "./index.ts", "--output", "./dist/index.js"],
    { cwd: __dirname }
  );
  ...
  expect(output).toMatchInlineSnapshot(`
    ...
    var modules = {
    /* --- index.ts --- */
    "index.ts": (function (exports, _kame_require_, module, __filename, __dirname, _kame_dynamic_import_) {
    ...
    return __kame__.runModule("index.ts", true);
    }
