  ...
  expect(run2.result).toMatchInlineSnapshot(`
    {
      ...
      'mkdtempDisposableSync', 'open',           'openSync',
      'openAsBlob',            'readdir',        'readdirSync',
      'read',                  'readSync',       'readv',
      'readvSync',             'readFile',       'readFileSync',
      'readlink',              'readlinkSync',   'realpath',
      'realpathSync',          'rename',         'renameSync',
      'rm',                    'rmSync',         'rmdir',
      'rmdirSync',             'stat',           'statfs',
      'statSync',              'statfsSync',     'symlink',
      ...
      'writevSync',            'Dirent',         'Stats',
      'ReadStream',            'WriteStream',    'FileReadStream',
      'FileWriteStream',       'Utf8Stream',     '_toUnixTimestamp',
      'Dir',
      ... 4 more items
    ]
    child_process {
